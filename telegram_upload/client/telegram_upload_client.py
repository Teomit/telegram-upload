...
class TelegramUploadClient(TelegramClient):
    ...
    def _send_file_message(self, entity, file, thumb, progress, reply_to):
        message = self.send_file(entity, file, thumb=thumb,
                                 ...
                                 caption=file.file_caption + file.file_caption_folder_tag + file.file_caption_from_txt_file, force_document=file.force_file,
                                 progress_callback=progress, attributes=file.file_attributes, reply_to=reply_to)
    ...
    def send_one_file(self, entity, file: File, send_as_media: bool = False, reply_to=None, thumb: Optional[str] = None,
                      retries=RETRIES):
        message = None
    ...
    def send_files(self, entity, files: Iterable[File], delete_on_success=False, print_file_id=False,
        ...
        for file in files:
            ...
            try:
                message = self.send_one_file(entity, file, send_as_media, reply_to, thumb=thumb)
            finally:
